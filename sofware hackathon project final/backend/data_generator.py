...
def _route_rows() -> pd.DataFrame:
    pairs = [("Bengaluru", "Chennai", 350), ("Bengaluru", "Hyderabad", 570), ("Hyderabad", "Delhi", 1_570), ("Chennai", "Vijayawada", 430), ("Mumbai", "Pune", 150), ("Delhi", "Jaipur", 280), ("Mumbai", "Ahmedabad", 530), ("Hyderabad", "Visakhapatnam", 620), ("Chennai", "Kochi", 690), ("Delhi", "Kolkata", 1_500)]
...
def demo_data() -> Tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame, pd.DataFrame]:
    ...
    vehicles = pd.DataFrame([
        ...
        {"vehicle_id": "V103", "current_location": "Bengaluru", "route_origin": "Bengaluru", "route_destination": "Hyderabad", "capacity_kg": 350, "current_load_kg": 50, "departure_time": now + timedelta(hours=2), "eta": now + timedelta(hours=14), "vehicle_status": "Available", "transport_cost": 2600, "vehicle_type": "Truck", "average_speed_kmph": 48},

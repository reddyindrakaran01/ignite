...
def demo_data() -> Tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame, pd.DataFrame]:
    ...
    shipments = pd.DataFrame([
        ...
        {"shipment_id": "S107", "origin": "Bengaluru", "current_location": "Bengaluru", "destination": "Delhi", "weight_kg": 200, "volume_m3": 2.5, "priority": "Critical", "deadline": now + timedelta(hours=65), "status": "Misplaced", "shipment_value": 200000, "created_at": now - timedelta(hours=1), "expected_transport_hours": 35, "delay_probability": .95, "route_risk": .40, "business_category": "Specialty Vaccines"},
    ])
